...
import { createFee } from "../../../redux/slices/feeSlice/feeSlice";
...
export default function FeeCreate({
  ...
  const handleSubmit = async () => {
    if (validate()) {
      try {
        ...
        showSuccessAlert('Success', 'Fee created successfully');
  ...
  return (
    <div className="px-4 py-8">
      <h1 className="text-2xl font-semibold text-gray-900">Create New Fee</h1>
      ...
      <div className="mt-8 flex gap-4">
        <Button variant="primary" label="Create Fee" onClick={handleSubmit} />
        <Button
          variant="secondary"
          label="Cancel"
